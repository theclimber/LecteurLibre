...
public class ArticleFragment extends Fragment {
    ...
    void loadWebView() {
        if (mWebView != null) {
            mWebView.loadData(mNewsArticle == null ? "" : mNewsArticle.getBody(), "text/html; charset=utf-8", "UTF-8");
            //mWebView.loadDataWithBaseURL("", mNewsArticle == null ? "" : mNewsArticle.getBody(), "text/html", "UTF-8", "");
        }
    }
}
